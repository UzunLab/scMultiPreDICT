#!/bin/bash
# ============================================================================
# Multi-Dataset Pipeline Submission - ATAC-only
# ============================================================================
#
# Submits the scMultiPreDICT ATAC-only pipeline for MULTIPLE datasets.
...
#   1: Metacell Creation (LSI-based kNN smoothing)
#   2: Feature Extraction (peak accessibility features)
...
declare -A STEP_DESCRIPTIONS=(
    [1]="Metacell Creation (LSI + kNN smoothing)"
...
Steps:
  1  Metacell Creation      LSI-based kNN smoothing for ATAC
  2  Feature Extraction     Peak accessibility features per target gene
