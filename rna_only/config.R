...
PROJECT_NAME <- "<YOUR_PROJECT_NAME>_RNA_only"
...
# ============================================================================
BASE_OUTPUT_DIR <- "<PATH_TO_OUTPUT_DIRECTORY>"  # e.g., "~/scMultiPreDICT_output/rna_only/processed/"
...
SLURM_LOG_DIR <- "<PATH_TO_SLURM_LOG_DIR>"  # e.g., "~/scRNA_only/jobs/logs"

# ============================================================================
# SECTION 11: RESULTS OUTPUT DIRECTORIES
# ============================================================================
BASE_RESULTS_DIR <- "<PATH_TO_RESULTS_DIRECTORY>"  # e.g., "~/scMultiPreDICT_output/rna_only/results/"
